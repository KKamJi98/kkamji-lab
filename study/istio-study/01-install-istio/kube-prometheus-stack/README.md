...
#### 2.4.1. Upgrading an existing Release to a new major version
...
## 5. PrometheusRules Admission Webhooks
...
### 5.1. How the Chart Configures the Hooks
...
## 6. Developing Prometheus Rules and Grafana Dashboards
...
## 9. Migrating from stable/prometheus-operator chart
...
## 11. Redeploy with new name (downtime)
...
## 12. Migrating from coreos/prometheus-operator chart
...
### 12.1. High-level overview of Changes

#### 12.1.1. Added dependencies
...
#### 12.1.2. Kubelet Service

Because the kubelet service has a new name in the chart, make sure to clean up the old kubelet service in the `kube-system` namespace to prevent counting container metrics twice.

#### 12.1.3. Persistent Volumes
