...
## 4. Upgrading an existing Release to a new major version

A major chart version change (like v1.2.3 -> v2.0.0) indicates that there is an
incompatible breaking change needing manual actions.

### 4.1. To 4.0.0 (And 3.12.1)
...
### 5.2. Example of extraVolumeMounts and extraVolumes
...
## 11. Sidecar for alerting resources
...
## 12. Statically provision alerting resources
...
### 12.1. Important notes on file provisioning
...
## 13. How to serve Grafana with a path prefix (/grafana)
...
## 14. How to securely reference secrets in grafana.ini
...
### 14.1. extraSecretMounts using a Container Storage Interface (CSI) provider
...
### 15.1. Image Renderer NetworkPolicy

By default the image-renderer pods will have a network policy which only allows ingress traffic from the created grafana instance

### 15.2. High Availability for unified alerting
