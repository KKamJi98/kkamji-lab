...
### 3.1. 1주차: 컨테이너 이미지 빌드 및 로컬 환경 구성
...
`CloudNet@` 커뮤니티의 **Gasida**님께 CI/CD 스터디 자료와 실습 기회를 제공해 주신 것에 감사드립니다.
